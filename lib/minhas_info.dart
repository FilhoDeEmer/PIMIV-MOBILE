...
class MinhasInf extends StatelessWidget {
  ...
  void _onDadosPessoaisButtonPressed() {
    // Ação para o botão "Dados pessoais"
  }
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Center(
                    child: Container(
                      margin: const EdgeInsets.fromLTRB(0, 0, 0, 0.27),
                      width: double.infinity,
                      child: const Text(
                        'MINHAS INFORMAÇÕES',
                        textAlign: TextAlign.center,
            ...
            Container(
              ...
              child: SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    TextButton(
                      onPressed: _onDadosPessoaisButtonPressed,
                      style: TextButton.styleFrom(
                        padding: EdgeInsets.zero,
                      ),
                      child: Container(
                        padding:
                            const EdgeInsets.fromLTRB(20, 11.5, 12.89, 11.5),
                        width: double.infinity,
                    ...
                    TextButton(
                      ...
                      child: Container(
                        padding:
                            const EdgeInsets.fromLTRB(15, 11.5, 12.89, 11.5),
                        width: double.infinity,
                        decoration: BoxDecoration(
                          color: const Color(0xffefefef),
                          borderRadius: BorderRadius.circular(8),
