...
class _LoginPageState extends State<LoginPage> {
  ...
  String _loginErrorMessage =
      ''; // Adiciona esta variável para armazenar a mensagem de erro de login
        ...
        if (responseUser.statusCode == 200) {
          ...
          if (credenciaisValidas && funcionarioData != null) {
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) =>
                    Principal(funcionarioData: funcionarioData),
              ),
            );
          } else {
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  TextField(
                    ...
                    keyboardType:
                        TextInputType.text, // Permitir letras e números
                  ...
                  if (_loginErrorMessage
                      .isNotEmpty) // Exibe a mensagem de erro se houver uma
                    Text(
                      _loginErrorMessage,
                      style: const TextStyle(
                        color: Colors.red,
