...
class _MinhasInfState extends State<MinhasInf> {
  ...
  Future<void> fetchData() async {
    ...
    final response = await http.get(Uri.parse('http://10.0.2.2:8080/empresa/'));
    ...
    setState(
        () {}); // Atualiza o estado para reconstruir a interface com as novas informações da empresa
  }
                                  ...
                                  children: [
                                    ...
                                    ElevatedButton(
                                      ...
                                      style: ElevatedButton.styleFrom(
                                        backgroundColor:
                                            const Color(0xffe3e3ff),
                                        foregroundColor:
                                            const Color(0xff212157),
